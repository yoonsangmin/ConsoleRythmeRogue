...
public:
    Player(GameLevel* refLevel, const wchar_t* str, const Vector2& position, int hp = 8, int drawOrder = 10, const Color& color = Color::BrightWhite);
